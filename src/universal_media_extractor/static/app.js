...
function humanNoticeTitle(code) {
  const titles = {
    ...
    cookies_required: "Session required",
    drm_protected: "Protected media",
    region_restricted: "Region restricted",
    private_or_deleted: "Unavailable source",
    no_requested_format: "Format unavailable",
    disk_full: "Disk full",
    permission_denied: "Permission needed",
    engine_outdated: "Media engine outdated",
    network_error: "Connection issue",
    timeout: "Timed out",
    ytdlp_not_found: "Media engine missing",
    ffmpeg_not_found: "ffmpeg missing",
    whisper_not_found: "Whisper missing",
...
function describeError(error) {
  const knownMessages = {
    ...
    cookies_required: "This source requires a browser session or cookies.",
    drm_protected: "This media appears to be DRM-protected.",
    region_restricted: "This media is not available in the current region.",
    private_or_deleted: "This source is private, deleted, or no longer available.",
    no_requested_format: "The selected output format is not available for this source.",
    disk_full: "There is not enough disk space to finish this operation.",
    permission_denied: "The app cannot read or write the selected path.",
    engine_outdated: "The local media engine may be outdated for this source.",
    ...
    ffmpeg_not_found: "ffmpeg was not found. Check the local environment and PATH.",
    whisper_not_found: "Whisper was not found. Check the local environment and PATH.",
    ...
    invalid_input_file: "The selected local file could not be used.",
    rights_confirmation_required: "Confirmation is required before processing.",
...
function suggestedActionForCode(code) {
  const actions = {
    ...
    cookies_required: "Use a public source, local file, or an explicitly supported private-session flow you control.",
    drm_protected: "Use the official offline option if one is available. The app does not bypass DRM.",
    region_restricted: "Use a source that is available in your region.",
    private_or_deleted: "Check the source page or use another link.",
    no_requested_format: "Analyze again and choose another output.",
    disk_full: "Free disk space or choose another output folder.",
    permission_denied: "Choose a different folder or grant file access.",
    engine_outdated: "Update the local media engine and retry.",
    network_error: "Check connectivity and retry.",
    timeout: "Retry later.",
    ytdlp_not_found: "Install yt-dlp or fix PATH, then retry.",
    ffmpeg_not_found: "Install ffmpeg or fix PATH, then retry.",
    whisper_not_found: "Install Whisper or fix PATH, then retry.",
    extractor_failed: "Retry later or use another source.",
    transcription_failed: "Check the local media file and retry.",
    invalid_input_file: "Choose a valid local audio or video file.",
  };
  return actions[code] || "";
}
